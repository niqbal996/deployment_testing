...
class TrtInfer():
    def __init__(self, trt_engine_path, topic, output_topic, batch_size=1, mode='ROS'):
        cuda.init()
        ...
        if mode=='ros':
            ...
            self.infer_video(path='/workspace/projects/lalweco/out.mp4')
    ...
    def infer_video(self, path):
        ...
        while(frame_count <= total_frames):
            ...
            frame_count +=1
            # print('Reading frame number {}'.format(frame_count))
            # outputs = []
...
if __name__ == '__main__':
    TrtInfer(
            trt_engine_path='/workspace/projects/lalweco/fp32_orin.engine',
